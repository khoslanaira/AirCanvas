...
# Initialize the video capture from EpocCam
cap = cv2.VideoCapture(0)  # Ensure the correct index for EpocCam, usually 0 or 1

if not cap.isOpened():
    print("Error: Could not find EpocCam.")
    exit()

print("EpocCam connected successfully.")
